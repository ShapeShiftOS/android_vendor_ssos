#
# ShapeShiftOS Audio Files
#

ALARM_PATH := vendor/ssos/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/ssos/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/ssos/prebuilt/common/media/audio/ringtones
