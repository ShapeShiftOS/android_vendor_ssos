...
ssos_manifest = ".repo/manifests/extras/ssos.xml"
...
def add_to_manifest(repos, fallback_branch=None):
    ...
    ssosm = load_manifest(ssos_manifest)
    ...
    for repo in repos:
        ...
        elif exists_in_tree(ssosm, repo_path) != None:
             existing_m_project = exists_in_tree(ssosm, repo_path)
